export default {
  ...
  types: {
    ...
    wg: {
      ...
      peerToPeer: "Allow WireGuard peers to communicate",
      peerToPeerHelp: "Routes traffic from this endpoint back to the same endpoint only for its virtual networks.",
      ...
      privateKeyExportHint: "Stored securely and revealed only in an explicit configuration export. Use the key button to rotate it.",
  ...
  analytics: {
    ...
    scannedLogs: "Scanned {count} INFO logs",
    users: "Users",
    inbounds: "Inbounds",
    outbounds: "Outbounds",
    nodes: "Nodes",
  ...
  logsView: {
    title: "Logs",
    subtitle: "Filter by time, user, severity or keyword to diagnose connection and configuration problems.",
    search: "Search",
    user: "User",
    level: "Level",
    from: "From",
