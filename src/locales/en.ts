export default {
  ...
  types: {
    ...
    wg: {
      ...
      peerToPeer: "Allow devices in this WireGuard network to reach each other through S-UI",
      peerToPeerHelp: "Traffic from this Endpoint is forwarded by the S-UI server to other devices in the same Endpoint. This is not a direct device-to-device tunnel.",
