export default {
  ...
  analytics: {
    ...
    scannedLogs: "Đã quét {count} log INFO",
    users: "Người dùng",
    inbounds: "Luồng vào",
    outbounds: "Luồng ra",
    nodes: "Nút mạng",
  ...
  logsView: {
    title: "Nhật ký",
    subtitle: "Lọc theo thời gian, người dùng, mức độ hoặc từ khóa để chẩn đoán kết nối và cấu hình.",
    search: "Tìm kiếm",
    user: "Người dùng",
    level: "Cấp độ",
    from: "Từ",
