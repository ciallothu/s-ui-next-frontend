export default {
  ...
  pages: {
	...
	analytics: "Использование и статистика",
	logs: "Логи",
  },
  main: {
    tiles: "Плитки",
  ...
  analytics: {
    ...
    scannedLogs: "Просканировано INFO логов: {count}",
    users: "Пользователи",
    inbounds: "Входящие",
    outbounds: "Исходящие",
    nodes: "Узлы",
  ...
  logsView: {
    title: "Логи",
    subtitle: "Фильтруйте по времени, пользователю, уровню или ключевому слову для диагностики подключений и настроек.",
    search: "Поиск",
    user: "Пользователь",
    level: "Уровень",
    from: "С",
