export default {
  ...
  tools: {
    ...
    keyPairsSubtitle: "Reality, WireGuard, WireGuard PSK, TLS и ECH",
    ...
    keyType: "Тип ключа: reality, wireguard, wireguard-psk, tls или ech",
  ...
  analytics: {
    ...
    network: "Сеть",
    scopePrivate: "Частная сеть",
    scopeLoopback: "Loopback",
    scopeLinkLocal: "Link-local",
    scopeMulticast: "Multicast",
    scopeReserved: "Зарезервированный адрес",
    scopePublic: "Публичный интернет",
    scopeDomain: "Доменное имя",
    scopeUnknown: "Неизвестно",
    message: "Сообщение",
    viewLog: "Открыть лог",
